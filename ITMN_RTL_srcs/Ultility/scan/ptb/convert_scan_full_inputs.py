...
def run():
    ...
    if a_log is not None:
        ...
        print("  -> Exported scan_real_A.txt (Flatten D_INNER x D_STATE)")
    ...
    if d_val is not None:
        ...
        with open("scan_real_D.txt", "w") as f:
            for val in D_fixed:
                f.write(to_hex(val) + "\n")
        print("  -> Exported scan_real_D.txt")
    ...
    if delta is not None:
        ...
        print("  -> Exported scan_real_delta.txt (Flatten Channel x Time)")
    ...
    if x_in is not None:
        ...
        print("  -> Exported scan_real_x.txt")
    ...
    if b_raw is not None:
        ...
        print("  -> Exported scan_real_B_shared.txt")
    ...
    if c_raw is not None:
        ...
        print("  -> Exported scan_real_C_shared.txt")
    ...
    if os.path.exists(path_y):
        ...
        if y_gated is not None:
            ...
            print("  -> Exported scan_real_y_golden.txt")
    else:
