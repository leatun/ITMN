# ============================================================================
# run_synth_only_vc709.tcl
#   OOC synth-only on VC709 project. Writes utilization + timing reports.
#   Assumes project already created via setup_project_vc709.tcl.
#
# Usage: source run_synth_only_vc709.tcl
# ============================================================================

set proj_dir [file normalize [file dirname [info script]]]
set rpt_dir  "${proj_dir}/reports_vc709"
file mkdir $rpt_dir
...
puts "==========================================="
puts "  Launching synth_1 (VC709, OOC, no impl)"
puts "==========================================="
reset_run synth_1
