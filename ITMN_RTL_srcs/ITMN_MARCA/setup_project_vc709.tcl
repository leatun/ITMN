...
#   Matches FastMamba/LightMamba paper HW baseline (VC709).
...
set proj_name "ITMN_MARCA_VC709"
...
set_property top tb_Mamba_Top_MAMBA1_130M [get_filesets sim_1]
...
puts "  Testbench: tb_Mamba_Top_MAMBA2 (Mamba1-130M default (MARCA workload))"
