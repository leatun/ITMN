# ============================================================================
# setup_project_zcu102.tcl
#   Create Vivado project targeting Xilinx Zynq UltraScale+ ZCU102 (xczu9eg-ffvb1156-2-e).
#   Matches eMamba paper HW baseline board.
#   No URAM (ZCU102 has URAM but small eMamba workloads use BRAM) - all memories use BRAM36 inference.
#
# Usage from Vivado Tcl Console:
#   cd C:/Users/ADMIN/Downloads/ITMN_MASTER/ITMN_RTL_srcs/ITMN_EMAMBA
#   source setup_project_zcu102.tcl
#
# Then run OOC synth via run_synth_only_zcu102.tcl.
# ============================================================================

set proj_name "ITMN_EMAMBA_ZCU102"
...
set_property top tb_Mamba_Top_EMAMBA_FMNIST [get_filesets sim_1]
...
puts ""
puts "============================================================"
puts "  Project ${proj_name} created for ZCU102 (${part})"
puts "  Sources: common/*.v, mamba/*.v, top/*.v"
puts "  Testbench: tb_Mamba_Top_MAMBA2 (Fashion-MNIST default; switch to _CIFAR10/_MARS/_WIKI2 as needed (MARCA workload))"
