...
module Mamba_Top (
    ...
    wire [14:0]  m5_w_addr_r0   = W_DTPROJ_BASE + ({6'b0, ctr_g} * {11'b0, DT_RANK}) + {10'b0, ctr_r};
    wire [14:0]  m5_w_addr_r1    = W_DTPROJ_BASE + ({6'b0, ctr_g} * {11'b0, DT_RANK}) + {10'b0, ctr_r_p1};
    wire [14:0]  m5_w_addr_r2    = W_DTPROJ_BASE + ({6'b0, ctr_g} * {11'b0, DT_RANK}) + {10'b0, ctr_r_p2};
    ...
    wire [14:0]  m5_w_addr_gnext_r0 = W_DTPROJ_BASE + ({6'b0, ctr_g_p1} * {11'b0, DT_RANK});
