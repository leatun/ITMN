...
module tb_Mamba_Top_MAMBA2_1_3B;
    ...
    localparam CH_OUT_V        = 9'd128;
    localparam CH_M_V          = 9'd256;
    localparam DT_RANK_V       = 4'd0;
    localparam N_STATE_GRP_V   = 4'd8;
    localparam USE_M5_V        = 1'b0;
    localparam XP_OUT_GRP_V    = 5'd20;   // dt(24)+B(128)+C(128)/16 = 18
    localparam integer N_LAYER = 48;
    localparam T_TEST          = 3;
    ...
    localparam integer DMA_CYC_PER_LAYER = 1615560;
