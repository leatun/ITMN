...
module Mamba_PE (
    ...
    wire signed [`ACC_W-1:0] w2_ext = {{(`ACC_W - `DATA_W){w2_ext[`DATA_W-1]}}, w2_ext};
    wire signed [`ACC_W-1:0] in_X  = {{(`ACC_W - `DATA_W){in_X[`DATA_W-1]}},  in_X};

    wire signed [`ACC_W-1:0] m1 = in_W1 * in_H;
    wire signed [`ACC_W-1:0] m2 = in_W2 * in_X;
