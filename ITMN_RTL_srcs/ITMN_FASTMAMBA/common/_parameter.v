...
// Widened dim ports (ITMN default: 4-bit is enough; Mamba2 needs 7-bit)
`define CH_OUT_W          7                 // supports d_model up to 128*16 = 2048
`define CH_M_W            7                 // supports d_inner up to 2048
`define CTR_G_W           7                 // ctr_g width

// Mamba2-130M explicit dims (for TB config / cycle model)
...
`define M2_CH_OUT_GRP     7'd48             // d_model/16
`define M2_CH_M_GRP       7'd96             // d_inner/16
