...
def test(params, ckpt_path, use_cpp):
    # get config
    ...
    # load model
    model = ITMN(n_classes=num_class, use_cpp_mamba=use_cpp, **model_config).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_cpp', action='store_true', help='Use C++ backend instead of PyTorch')
    ...
    test(config, ckpt_path, args.use_cpp)
